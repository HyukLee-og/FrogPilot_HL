...
frogpilot_default_params: list[tuple[str, str | bytes, int]] = [
  ...
  ("SshEnabled", "0", 0),
  ("StartupMessageTop", "OpenPilot 사용 가능", 0),
  ("StartupMessageBottom", "항시 전방을 주시하고 교통 상황에 유의하세요", 0),
...
class FrogPilotVariables:
  ...
  def update(self, holiday_theme, started, boot_run=False):
    ...
    aol_memory = params_memory.get("AlwaysOnLateral")
    if aol_memory is not None:
      toggle.always_on_lateral = aol_memory == b"1"
    else:

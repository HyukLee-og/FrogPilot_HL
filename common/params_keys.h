...
inline static std::unordered_map<std::string, ParamKeyAttributes> keys = {
    ...
    {"APNDataActive", {CLEAR_ON_MANAGER_START, BOOL}},
    {"APNDataKind", {CLEAR_ON_MANAGER_START, STRING}},
    {"APNDataTimestamp", {CLEAR_ON_MANAGER_START, FLOAT, "0.0"}},
    {"APNLastRGData", {CLEAR_ON_MANAGER_START | DONT_LOG, STRING}},
    {"APNLatitude", {CLEAR_ON_MANAGER_START, FLOAT, "0.0"}},
    {"APNLongitude", {CLEAR_ON_MANAGER_START, FLOAT, "0.0"}},
    {"APNNextHazard", {CLEAR_ON_MANAGER_START, STRING}},
    {"APNNextHazardDistance", {CLEAR_ON_MANAGER_START, FLOAT, "0.0"}},
    {"APNNextSpeedLimit", {CLEAR_ON_MANAGER_START, FLOAT, "0.0"}},
    {"APNNextSpeedLimitDistance", {CLEAR_ON_MANAGER_START, FLOAT, "0.0"}},
    {"APNRoadName", {CLEAR_ON_MANAGER_START, STRING}},
    {"APNSpeedLimit", {CLEAR_ON_MANAGER_START, FLOAT, "0.0"}},
    {"APNFakeLong", {PERSISTENT, BOOL, "0"}},
    {"APNFakeLongOffset", {PERSISTENT, INT, "0"}},
    {"AlwaysOnDM", {PERSISTENT, BOOL}},
    {"ApiCache_Device", {PERSISTENT, STRING}},
    {"ApiCache_FirehoseStats", {PERSISTENT, JSON}},
    {"UseAPN", {PERSISTENT, BOOL, "0"}},
    ...
    {"IgnoreSeatbeltUnlatched", {PERSISTENT, BOOL, "0"}},
    ...
    {"OffroadWakeCounter", {CLEAR_ON_MANAGER_START, INT, "0"}},
    ...
    {"FakeLong", {PERSISTENT, BOOL, "0", "0", 2}},
    {"FakeLongDebug", {CLEAR_ON_MANAGER_START, STRING, "", ""}},
    {"FakeLongTestButton", {CLEAR_ON_MANAGER_START, STRING, "", ""}},
    {"FakeLongTestUI", {PERSISTENT, BOOL, "0", "0", 2}},

Version 2.1 (2026-02-09)
========================
* 한국어 번역 수정 (부팅 메시지, 파이어호스 모드 등)
* 기본 부팅 알림 메시지 변경 (OpenPilot 활성화 가능 / 항시 전방을 주시하고 교통 상황에 유의하세요)
* 사운드 설정: 기본 'tesla' (단, engage/disengage는 순정 소리 강제 적용)

Version 2.0 (2026-02-09)
========================
* 주행 통계 위젯 수정 (FrogPilot 통계만 표시)

Version 1.9 (2026-02-09)
========================
* 커스텀 이벤트(accel30, accel35, hal9000) 로직 수정

Version 1.8 (2026-02-09)
========================
* 부팅 로고 지속 문제 수정

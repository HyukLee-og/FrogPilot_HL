Version 1.7.0 (2026-02-19)
========================
* 스티어링 휠 아이콘 변경 (Custom Chffr Wheel)
* 오디오 파일 업데이트 (Prompt, Refuse, Warning Immediate)
* 속도 표시 형식 개선 (10 km/h -> 10km/h)

Version 1.6.6 (2026-02-09)
========================
* 커스텀 사운드 오버라이드 기능 롤백
  * `downloaded_themes` 폴더의 파일을 이용한 부분적 사운드 변경 기능 삭제 (안정성 확보 목적)

Version 1.6.5 (2026-02-09)
========================
* 커스텀 사운드 오버라이드 기능 추가
  * `downloaded_themes` 폴더에 `engage4.wav`, `disengage4.wav` 파일이 존재할 경우, 해당 파일을 최우선으로 적용 (기존 테마 사운드 대체)

Version 1.6.4 (2026-02-09)
========================
* 조향 비활성화 (Below Steer Speed) 알림 변경
  * 전체 화면 표시 및 배경색 변경 (검은색/회색 톤)
  * 알림 소리 제거 (무음)

Version 1.6.3 (2026-02-08)
==========================
* 상시 조향 (AOL) 토글 기능 롤백
  * 취소(Cancel) 버튼을 통한 상시 조향 On/Off 기능 삭제 (순정 상태로 복구)
...
========================
* 상시 조향 토글 상세 개선
  * 크루즈 비활성화(Disengaged) 상태에서도 버튼 입력 인식 및 토글 가능
  * 순정 크루즈 모드 호환성 강화

Version 1.6.1 (2026-02-07)
==========================
* 상시 조향 (AOL) 토글 개선
  * 버튼 입력 시간 단축: 2초 -> **1초**
  * 버그 수정: 기본 설정이 켜져 있을 때 버튼으로 꺼지지 않던 문제 해결 (버튼 우선 순위 적용)
  * **기기 등록 건너뛰기**: 초기 부팅 시 서버 등록 과정을 생략하고 자동으로 가짜 ID를 생성하여 바로 진입하도록 변경

Version 1.6 (2026-02-05)
========================
* 상시 조향 (Always On Lateral) 토글 방식 개선
  * 버튼 변경: 크루즈 거리 조절(Gap) -> 크루즈 해제(Cancel) 버튼 (2초 간 입력)
  * 동작 변경: 영구 설정 토글 -> 현재 주행 중 임시 활성화 (재시동 시 꺼짐)
  * 버그 수정: 순정 크루즈 사용 시 버튼 입력 무시되던 현상 해결

Version 1.5 (2026-02-05)
========================
* 상시 조향 (Always On Lateral) 버튼 토글 기능 추가
  * 크루즈 거리 조절 버튼(Gap Adjust) 2초 이상 입력 시 On/Off 가능
  * 활성화/비활성화 시 화면 텍스트 알림 및 효과음(Engage/Disengage) 제공
* 시동 문구 및 Engagement 텍스트 사용자화 적용
* 오픈파일럿 시스템 오류 (Crashed) 이벤트 한글 번역 적용

Version 1.4 (2026-02-05)
========================
* 랜덤 크래시 시스템 오류 알림 정상화 (이모지 삭제 및 경고음 변경)
...
========================
* 선행 차량 출발 알림 메시지가 한글로 더욱 명확하게 표시됩니다.

Version 0.9.7.4.3 (2025-07-18)
========================
carstate.py op와 계기판 싱크 시도 - 롤백 - 에러 해결

Version 0.9.7.4.3 (2025-07-18)
========================
carstate.py op와 계기판 싱크 시도 - 롤백

Version 0.9.7.4.2 (2025-07-18)
========================
carstate.py op와 계기판 싱크 시도 2

Version 0.9.7.4.1 (2025-07-18)
========================
carstate.py op와 계기판 싱크 시도 1

Version 0.9.7.3.3 (2025-06-17)
========================
events.py 일부 이벤트 디테일 수정

Version 0.9.7.3.2 (2025-06-16)
========================
부팅시 이벤트 디테일 추가

Version 0.9.7.3.1 (2025-06-16)
========================
갖가지 이벤트에 디테일 추가

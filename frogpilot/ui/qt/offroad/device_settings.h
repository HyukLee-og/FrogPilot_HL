...
private:
  ...
  QSet<QString> deviceManagementKeys = {"DeviceShutdown", "DisableForcedPowerLogic", "HigherBitrate", "IncreaseThermalLimits", "LowVoltageShutdown", "NoLogging", "NoUploads", "UseKonikServer"};
